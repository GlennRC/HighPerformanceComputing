...
int main(int argc, char** argv) 
{
    ...
    suppression(&sup_image, mag_image, phase_image, size, size);
    
    edge(&hyst_image, sup_image, size, size);

    edge_link(&edge_image, hyst_image, size, size);
    sprintf(name, "edge.pgm");
    write_image_template(name, edge_image, size, size);
